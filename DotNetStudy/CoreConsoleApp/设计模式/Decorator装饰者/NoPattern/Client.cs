...
namespace CoreConsoleApp.设计模式.Decorator装饰者.NoPattern
{
    public class Client
    {
        public static void Index()
        {
            ...
            double zs = Prize.CalcPrize("张三", DateTime.Now, DateTime.Now);
            Console.WriteLine("==========张三应得奖金：" + zs);
            double ls = Prize.CalcPrize("李四", DateTime.Now, DateTime.Now);
            Console.WriteLine("==========李四应得奖金：" + ls);
            double ww = Prize.CalcPrize("王五", DateTime.Now, DateTime.Now);
