...
namespace CoreConsoleApp.设计模式.Visitor访问者模式.X.大忽悠公司NG
{
    public class LiveAppVisitor : IVisitor
    {
        ...
        {
            Console.WriteLine($"{programmer.GetName()}: 最近小视频很火啊，咱能不能抄袭下抖音，搞他一炮,将来公司上市了，你的身价至少也是几千万，甚至上亿...", programmer.GetName());
        }
        ...
        {
            Console.WriteLine($"{sales.GetName()}: 你也开个账户，边测试边直播，两不耽误...", sales.GetName());
        }
    }
}
